...
public class Weapon extends Item {
    ...
    /**
     * Sets ID to a new ID.
     * @effect	The ID is set an in the method setID() in Item.
     * 			| super.setID(weaponID)
     */
    public final void setID(long weaponID){
        super.setID(weaponID);
    }
     ...
     * @return	True if the value of the weapon is higher than or equal to zero
     * 			and if the value is lower than or equal to the max value.
