	...
	*/
	...
	public float getEquipmentLoad() {
		for (Weapon weapon: weapons) {
			equipmentLoad += weapon.getWeight();
		}
	...
	public boolean canHaveAsWeapon(Weapon weapon) {
		return ((weapon != null) && (weapon.isValidHolder(this) == true) && ((this.getCarryingCapacity() - this.getEquipmentLoad()) >= weapon.getWeight()));
	}
